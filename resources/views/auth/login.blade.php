                ...
                <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
                            ...
                            <form class="form" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="text-center pb-8">
                                    ...
                                    <span class="text-muted font-weight-bold font-size-h4">Atau
                                        <a href="https://api.whatsapp.com/send/?phone=6288229600629&text&app_absent=0" class="text-primary font-weight-bolder">WA Admin</a></span>
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Form group-->
                                    <div class="form-group">
                                        <label class="font-size-h6 font-weight-bolder text-dark">Email</label>
                                        <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="email" name="email" value="{{ old('email') ? old('email') : 'demo@demo-web.my.id' }}" />
                                    </div>
                                    <!--end::Form group-->
                                    <!--begin::Form group-->
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="password" name="password" autocomplete="off" value="12345" />
                                    </div>
                                    <!--end::Form group-->
                                    <!--begin::Action-->
                                    <div class="text-center pt-2">
                                        <button type="submit" id="" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">Sign In</button>
                                    </div>
                                    <!--end::Action-->
                                </form>
                                <!--end::Form-->
                    ...
                    <div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #B1DCED;">
                        ...
                        <div class="d-flex flex-column justify-content-center text-center  pt-md-5 pt-sm-5 px-lg-0 pt-5 px-7">
                            <h3 class="display4 font-weight-bolder my-7 text-dark" style="color: #986923;">Restaurant Management</h3>
