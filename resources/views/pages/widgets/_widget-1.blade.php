<div class="card card-custom bg-gray-100 card-stretch gutter-b">
            ...
            <div class="card-header border-0 bg-danger py-5">
                <h3 class="card-title font-weight-bolder text-white">Statistik Penjualan</h3>
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                            ...
                            <ul class="navi navi-hover">
                                <li class="navi-header">
                                    <span class="text-primary text-uppercase font-weight-bold">File:</span>
                                </li>
                                <li class="navi-item">
                ...
                <div class="card-spacer mt-n25">
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                            {{ Metronic::getSVG("media/svg/icons/Shopping/Box1.svg", "svg-icon-3x svg-icon-primary d-block my-2") }}
