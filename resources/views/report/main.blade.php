...
@section('page_title', 'Maintenance Page')
{{-- Content --}}
@section('content')
<div class="d-flex flex-column-fluid">
    <div class="container row"> 
        ...
        <div class="text-center pt-15">
            <h1 class="font-weight-bolder text-dark mb-6">Dalam Tahap Masa Pengembangan</h1>
            <div class="h4 text-dark-50">Beritahu kami jika anda menemukan error</div>
            <div class="row">
                <div class="offset-md-3 col-md-6">
                    <span class="svg-icon svg-icon-full">
                        <!--begin::Svg Icon | path:assets/media/svg/illustrations/data-points.svg-->
