            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Orders Data Table
        ...
        var datatable = $('#kt_datatable').KTDatatable({
                ...
                template: function(row) {
                    var status = {
                        '0': {
                            ...
                            'class': 'label-light-danger label-pill'
                        },
                        '1': {
                            'title': 'Payed',
                            'class': 'bg-light-success label-pill'
                        },
                    };
            ...
            },
            {
                ...
                template: function(row) {
                    ...
                    return '<a href="'+'{{ route('order.detail') }}/'+row.id+'" class="btn btn-sm btn-clean btn-icon mr-2" data-table="'+row.id+'" title="Edit details">\
                    <span class="flaticon-eye icon-md">\
                    </span>\
                    </a>\
