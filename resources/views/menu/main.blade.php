    ...
    <div class="container">
        <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
            ...
            <div class="alert-text">
                ...
                <a class="font-weight-bold" href="https://www.restaurant-website-builder.com/restaurant-menu-descriptions" target="_blank">How to write "delicious" restaurant menu</a>.
            </div>
        </div>
        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            },
            {
                ...
                template: function(row) {
                    ...
                    <li class="navi-item">\
                    <a href="#" class="navi-link '+status[row.status].class+'">\
                    <span class="navi-icon"><i class="las la-sliders-h"></i></span>\
                    <span class="navi-text">'+status[row.status].title+'</span>\
                    </a>\
                    </li>\
                    </ul>\
                    </div>\
                    </div>\
                    <a href="'+'{{ route('menu.update') }}/'+row.id+'" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
                    <span class="svg-icon svg-icon-md">\
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                    <rect x="0" y="0" width="24" height="24"/>\
...
{{-- <script src="{{ asset('js/pages/crud/ktdatatable/base/data-json.js') }}"></script> --}}
@endsection
